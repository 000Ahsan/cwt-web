...
export const avatarsData: Avatar[] = [
  ...
  {
    imgClass: 'img-50 rounded-circle',
    img: 'assets/images/user/10.jpg',
  },
  {
  ...
  {
    imgClass: 'img-30 rounded-circle',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-20 rounded-circle',
    img: 'assets/images/user/10.jpg',
  },
];

// Example typed arrays
export const avatarsData1: Avatar[] = [
  {
    imgClass: 'img-100',
  ...
  {
    imgClass: 'img-90',
    statusClass: 'status-90',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-80',
    statusClass: 'status-80',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-70',
    statusClass: 'status-70',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-60',
    statusClass: 'status-60',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-50',
  ...
  {
    imgClass: 'img-40',
    statusClass: 'status-40',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-30',
    statusClass: 'status-30',
    img: 'assets/images/user/10.jpg',
  },
  {
    imgClass: 'img-20',
    statusClass: 'status-20',
    img: 'assets/images/user/10.jpg',
  },
];

export const avatarsData2: Avatar[] = [
  { imgClass: 'img-100 rounded-circle', img: 'assets/images/user/16.png' },
  { imgClass: 'img-90 rounded-circle', img: 'assets/images/user/16.png' },
  { imgClass: 'img-80 rounded-circle', img: 'assets/images/user/16.png' },
  { imgClass: 'img-70 rounded-circle', img: 'assets/images/user/16.png' },
  { imgClass: 'img-60 rounded-circle', img: 'assets/images/user/16.png' },
  { imgClass: 'img-50 rounded-circle', img: 'assets/images/user/10.jpg' },
  { imgClass: 'img-40 rounded-circle', img: 'assets/images/user/10.jpg' },
  { imgClass: 'img-30 rounded-circle', img: 'assets/images/user/10.jpg' },
  { imgClass: 'img-20 rounded-circle', img: 'assets/images/user/10.jpg' },
];

export const avatarsData3: Avatar[] = [
  { imgClass: 'img-100 b-r-8', img: 'assets/images/user/1.jpg' },
  { imgClass: 'img-90 b-r-30', img: 'assets/images/user/1.jpg' },
  { imgClass: 'img-80 b-r-35', img: 'assets/images/user/1.jpg' },
  { imgClass: 'img-70 rounded-circle', img: 'assets/images/user/1.jpg' },
  { imgClass: 'img-60 b-r-25', img: 'assets/images/user/1.jpg' },
  { imgClass: 'img-50 b-r-15', img: 'assets/images/user/1.jpg' },
];

export const avatarsData4: Avatar[] = [
  {
    imgClass: 'b-r-8 height-100',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
  {
    imgClass: 'b-r-8 height-90',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
  {
    imgClass: 'b-r-8 height-80',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
  {
    imgClass: 'b-r-8 height-70',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
  {
    imgClass: 'b-r-8 height-60',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
  {
    imgClass: 'b-r-8 height-50',
    avatarClass: 'ratio1',
    img: 'assets/images/user/1.jpg',
  },
];

export const paddingData = `.p-0 {
        padding: 0px;
        } 
    .p-5 {
        padding: 5px;
...
export const paddingLeft = `.p-l-0 {
    padding-left: 0px;
    }
    .p-l-5 {
    padding-left: 5px;
...
export const paddingRight = `.p-r-0 {
    padding-right: 0px;
    }
    .p-r-5 {
    padding-right: 5px;
...
export const paddingBottom = `.p-b-0 {
...
export const marginRight = `.m-r-0 {
    margin-right: 0px;
    }
    .m-r-5 {
    margin-right: 5px;
...
export const marginBottom = `.m-b-0 {
...
export const imageSizes = `.img-10 {
...
export const textColor = `.font-primary {
...
export const badgeColor = `.badge-primary {
...
export const backgroundColor = `.badge-primary {
        background-color: #7366ff;
        }
        .badge-secondary {
        background-color: #f73164;
...
export const buttonColor = `.btn-primary {
    background-color: #7366ff;
    border-color: #7366ff;
    }
    .btn-secondary {
...
export const borderRadius = `.b-r-0 {
...
export const fontWeight = `.f-w-100 {
    font-weight: 100;
    }
    .f-w-300 {
    font-weight: 300;
...
export const fontStyle = `.f-s-normal {
    font-style: normal;
    }
    .f-s-italic {
    font-style: italic;
