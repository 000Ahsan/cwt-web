...
export const filter: Filter[] = [
  {
    ...
    isCollapsed: false,
    checkBoxs: [
      { id: 1, checkTitle: 'London', subTitle: 'London (69)' },
      { id: 2, checkTitle: 'New York', subTitle: 'NY (39)' },
      { id: 3, checkTitle: 'Contrary', subTitle: 'Con (45)' },
      { id: 4, checkTitle: 'Chicago', subTitle: 'IL (63)' },
      { id: 5, checkTitle: 'Seattle', subTitle: 'WA (249)' },
    ],
  ...
  },
  {
    ...
    isCollapsed: false,
    checkBoxs: [
      { id: 6, checkTitle: 'UI/Ux designer(25)' },
      { id: 7, checkTitle: 'Graphic designer(10)' },
      { id: 8, checkTitle: 'Front end designer(15)' },
      { id: 9, checkTitle: 'PHP developer(42)' },
      { id: 10, checkTitle: 'React Developer(5)' },
    ],
  ...
  },
  {
    ...
    isCollapsed: false,
    checkBoxs: [
      { id: 11, checkTitle: 'Computer Software(14)' },
      { id: 12, checkTitle: ' IT Engineer(10)' },
      { id: 13, checkTitle: 'Service industry(20)' },
      { id: 14, checkTitle: 'Accounting(34)' },
      { id: 15, checkTitle: ' Financial Services(5)' },
    ],
    button: 'All Industry',
  },
  {
    ...
    isCollapsed: false,
    checkBoxs: [
      { id: 16, checkTitle: 'HTML,scss & sass' },
      { id: 17, checkTitle: 'Javascript' },
      { id: 18, checkTitle: ' Node.js' },
      { id: 19, checkTitle: 'Gulp & Pug' },
      { id: 20, checkTitle: 'Angular.js' },
    ],
    button: 'All Skills',
  },
];
