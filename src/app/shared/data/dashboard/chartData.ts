...
export let bar: BarChartOptions = {
  series: [
    {
      name: 'Yearly Profit',
      data: [
...
export let Transaction: TransactionChartOptions = {
  series: [
    {
      name: 'series1',
...
export let sales: SalesChartOptions = {
  series: [
    {
      data: [
        [1327359600000, 65.95],
...
export let growthChart: GrowthChartOptions = {
  series: [76, 67, 61, 90],
  chart: {
    height: 380,
    type: 'radialBar',
...
export let invoice: InvoiceChartOptions = {
  chart: {
    type: 'line',
    height: 450,
    foreColor: '#999',
  ...
  series: [
    {
      name: 'Total Views',
      // cast each array to [number, number]
      data: generateDayWiseTimeSeries(0, 18) as [number, number][],
    },
    {
      name: 'Unique Views',
      data: generateDayWiseTimeSeries(1, 18) as [number, number][],
    },
  ],
  markers: {
    size: 5,
...
export let topSales: TopSalesChartOptions = {
  series: [
    {
      name: 'TEAM A',
      type: 'area',
...
export let activityChart: ActivityChartOptions = {
  series: [
    {
      name: 'Inflation',
      data: [
...
export let yearly: YearlyChartOptions = {
  series: [
    {
      name: 'Yearly Profit',
      data: [
